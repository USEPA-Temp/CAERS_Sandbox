 ...
 */
function initCromerrWidget(userRoleId, token, baseServiceUrl, emissionsReportId, mfrId, toastr, emitter, userFeedbackEnabled, feedbackSubmitted){
    ...
    if (checkIfScriptExists(baseServiceUrl+cromerrJS)) {
        initializeCromerrWidget(userRoleId, token, baseServiceUrl, emissionsReportId, mfrId, toastr, emitter, userFeedbackEnabled, feedbackSubmitted);
    } else {
...
function initializeCromerrWidget(userId, userRoleId, baseServiceUrl, emissionsReportId, mfrId, toastr, emitter, feedbackEnabled, feedbackSubmitted){
